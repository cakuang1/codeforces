...
int main() {
    ...
    // wd esotowwhtiw wr werk we
    // wrehow wu dsly ssouvsetls hww so thsi dn wrhw dstesi wuw work  we

    // wthe ggcd w=. wk w
    // wgcd () x, w= wrk wr
    //gcd wr() we = 1 we
    // we can repharseteh statew wrmetn wer
    
    // wwtshi wrare bothwerompl san wher wy ersd sthi ww his amtterw e
